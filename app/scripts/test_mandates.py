"""SHIM - the suite lives in tests/test_mandates.py.
...
claim about the project that is no longer true.
  ...
  uv run python scripts/test_mandates.py   ->   pytest tests/test_mandates.py
...
raise SystemExit(pytest.main([
    str(ROOT / "tests" / "test_mandates.py"), "-q", "-p", "no:cacheprovider"]))
